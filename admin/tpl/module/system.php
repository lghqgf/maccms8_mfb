...
elseif($method=='configweixinsave'){
	...
	$config['weixin']['msgtype'] = trim(be('post','weixin_msgtype'));
...
elseif($method=='configweixin'){
	...
	$arr=array(
		array('p'=>'weixin','a'=>'bofang','c'=>$MAC['weixin']['bofang'],'t'=>0,'n'=>array('内容页面','播放页面','搜索页面') ,'v'=>array(0,1,2) ),
		array('p'=>'weixin','a'=>'msgtype','c'=>$MAC['weixin']['msgtype'],'t'=>0,'n'=>array('图文','文字') ,'v'=>array(0,1) )
	);
	foreach($arr as $a){
